...
namespace AFMSDataViewer
{
    public class RealtimeResultChartControl : TableLayoutPanel
    {
        ...
        public RealtimeResultChartControl(ChartMainType chartType)
        {
            ...
            ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 45F));
            ...
            uiComboMain.Margin = new Padding(3);
            ...
            uiComboSub.Margin = new Padding(3);
        ...
        private static void SetupValueCard(RoundedTwoLabel card, string key, ChartMainType chartType, bool highlighted = false)
        {
            ...
            card.LbKey.TextAlign = ContentAlignment.BottomCenter;
            card.LbKey.Padding = Padding.Empty;
            card.LbValue.TextAlign = ContentAlignment.TopCenter;
